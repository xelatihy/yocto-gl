...
cl /Febin/ytestgen.exe /Fdbin/ytestgen.exe.pdb bin/ytestgen.obj bin/yocto.lib bin/yapp.obj bin/tinyply.obj /Zi
cl  /O2 /Zi /EHsc /bigobj /Iapps/w32/include /c /Fdbin/ytrace.obj.pdb /Fobin/ytrace.obj apps/ytrace.cpp
cl /Febin/ytrace.exe /Fdbin/ytrace.exe.pdb bin/ytrace.obj bin/yocto.lib bin/yapp.obj bin/tinyply.obj /Zi
