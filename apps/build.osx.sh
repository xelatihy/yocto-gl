...
clang++ -MMD -MF bin/tinyply.o.d -std=c++14 -stdlib=libc++ -O3 -g -fcolor-diagnostics -I/usr/local/include -c -o bin/tinyply.o apps/tinyply.cpp
...
clang++ -o bin/ytrace bin/ytrace.o bin/yapp.o bin/tinyply.o bin/yocto.a -std=c++14
...
clang++ -o bin/yobj2gltf bin/yobj2gltf.o bin/yapp.o bin/tinyply.o bin/yocto.a -std=c++14
