...
- math library
    - use vec3<T>, frame3<T>, mat4<T> etc ...
    - for now use template using directives
    - then we might be able to remove template specialization
    - consider templates for the book
        - frankly this aligns it with yocto/XXX
- luts
- tone curve
    - from web?
