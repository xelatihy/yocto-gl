...
def view(directory='mcguire', scene='*', format='json', mode='path'):
    modes = {
        'path': '-r 720',
        'embree': '-r 720 --embreebvh --highqualitybvh',
...
def render(directory='mcguire', scene='*', format='json', mode='path'):
    modes = {
        ...
        'embree': '-s 256 -r 1280 --embreebvh --highqualitybvh',
        'embree-compact': '-s 256 -r 1280 --embreebvh',
        'eyelight': '-s 16 -r 1280 -t eyelight',
        'embree-face': '-s 1024 -r 1280 --embreebvh --highqualitybvh',
        'final': '-s 4096 -r 1280 --embreebvh --highqualitybvh',
        'final-compact': '-s 4096 -r 1280 --embreebvh',
        'final-face': '-s 4096 -r 1280 --embreebvh --highqualitybvh',
    }
    options = modes[mode]
